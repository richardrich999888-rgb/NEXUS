...
const ROOT = "/Users/richardrich/Desktop/NEXUS/docs/idex-open-challenge-2026/02-bioshield-swarm/final_4_documents";
...
const documents = [
  [
    "01_SYNTRIASS_BioShield_Swarm_Annexure_1_Applicant_Details_and_Solution_Summary.md",
    "01_SYNTRIASS_BioShield_Swarm_Annexure_1_Applicant_Details_and_Solution_Summary.pdf",
    "Annexure Outline",
    "Company identification and section outline"
  ],
  [
    "02_SYNTRIASS_BioShield_Swarm_Annexure_2_Technical_Architecture.md",
    "02_SYNTRIASS_BioShield_Swarm_Annexure_2_Technical_Architecture.pdf",
    "Annexure-2",
    "Technical architecture and implementation approach"
  ],
  [
    "03_SYNTRIASS_BioShield_Swarm_Annexure_3_Advantages_and_Competencies.md",
    "03_SYNTRIASS_BioShield_Swarm_Annexure_3_Advantages_and_Competencies.pdf",
    "Annexure-3",
    "Advantages, capabilities, and competencies"
  ],
  [
    "04_SYNTRIASS_BioShield_Swarm_Annexure_4_Supporting_Evidence_and_Screenshots.md",
    "04_SYNTRIASS_BioShield_Swarm_Annexure_4_Supporting_Evidence_and_Screenshots.pdf",
    "Annexure-4",
...
function chromePdf(htmlPath, pdfPath) {
  const profileDir = path.join("/private/tmp", `syntriass-chrome-${process.pid}-${path.basename(pdfPath, ".pdf")}`);
  ...
  try {
    execFileSync(CHROME, args, { stdio: "inherit", timeout: 45000 });
  } catch (error) {
    const writtenBytes = fs.existsSync(pdfPath) ? fs.statSync(pdfPath).size : 0;
    if (writtenBytes < 100000) {
      throw error;
    }
    console.warn(`Chrome exited after writing ${writtenBytes} bytes; keeping ${pdfPath}`);
  } finally {
    fs.rmSync(profileDir, { recursive: true, force: true });
  }
}
