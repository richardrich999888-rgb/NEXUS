...
const ROOT = "/Users/richardrich/Desktop/NEXUS/docs/idex-open-challenge-2026/01-nexus-guard/final_4_documents";
...
const documents = [
  [
    "01_SYNTRIASS_NEXUS_Guard_Annexure_1_Applicant_Details_and_Solution_Summary.md",
    "01_SYNTRIASS_NEXUS_Guard_Annexure_1_Applicant_Details_and_Solution_Summary.pdf",
    "Annexure Outline",
    "Company identification and section outline"
  ],
  [
    "02_SYNTRIASS_NEXUS_Guard_Annexure_2_Technical_Architecture.md",
    "02_SYNTRIASS_NEXUS_Guard_Annexure_2_Technical_Architecture.pdf",
    "Annexure-2",
    "Technical architecture and implementation approach"
  ],
  [
    "03_SYNTRIASS_NEXUS_Guard_Annexure_3_Advantages_and_Competencies.md",
    "03_SYNTRIASS_NEXUS_Guard_Annexure_3_Advantages_and_Competencies.pdf",
    "Annexure-3",
    "Advantages, capabilities, and competencies"
  ],
  [
    "04_SYNTRIASS_NEXUS_Guard_Annexure_4_Supporting_Evidence_and_Screenshots.md",
    "04_SYNTRIASS_NEXUS_Guard_Annexure_4_Supporting_Evidence_and_Screenshots.pdf",
    "Annexure-4",
